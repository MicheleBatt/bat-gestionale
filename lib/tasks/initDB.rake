...
namespace :initDB do
  ...
  task :init_db => :environment do
    ...
    if Rails.env.test? || response.downcase == 'y'
      ...
      [
        Date.new(2021, 5, 5), Date.new(2021, 12, 9), Date.new(2022, 7, 28), Date.new(2022, 10, 12),
        Date.new(2022, 11, 10), Date.new(2023, 1, 31), Date.new(2023, 2, 28), Date.new(2023, 4, 14),
        Date.new(2023, 10, 3), Date.new(2023, 10, 4), Date.new(2024, 2, 6), Date.new(2024, 4, 5),
        Date.new(2024, 4, 23), Date.new(2024, 7, 1), Date.new(2024, 12, 4), Date.new(2025, 1, 9),
        Date.new(2025, 4, 15), Date.new(2025, 4, 29), Date.new(2025, 5, 26), Date.new(2025, 9, 1),
        Date.today - 1.day
      ].each do | date |
