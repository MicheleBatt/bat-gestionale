class MovementsController < ApplicationController
  ...
  def index
    ...
    @all_movements = @count.movements.includes(:metal_value)
  ...
  def create
    ...
    respond_to do |format|
      if @movement.save
        format.html { redirect_to @count.movements_default_path(@movement.year, @movement.month), notice: "Movimento di cassa aggiunto correttamente" }
  ...
  private
    ...
    def movement_params
      params.require(:movement).permit(:count_id, :expense_item_id, :amount, :causal, :movement_type, :emitted_at, :year, :month, :karat, :price_per_gram_at_transaction)
    end
