class DeadlinesController < ApplicationController
  ...
  def index
    @search = @organization.deadlines.all.ransack(params[:q])
  ...
  def create
    ...
    respond_to do |format|
      if @deadline.save
        format.html { redirect_to organization_deadlines_path(@organization), notice: "Nuova scadenza aggiunta correttamente allo scadenziario" }
  ...
  def destroy
    ...
    respond_to do |format|
      ...
      format.html { redirect_to organization_deadlines_path(@organization), status: :see_other, notice: "Scadenza rimossa dallo scadenziario" }
  ...
  private
    ...
    def deadline_params
      params.require(:deadline).permit(:description, :expired_at, :year, :organization_id)
    end
end
